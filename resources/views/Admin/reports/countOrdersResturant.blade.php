            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        <div>
                            <h1>{{ __('dashboard.countOrdersResturant') }}</h1>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="progress-widget">
                                        ...
                                        <div class="progress-detail">
                                            <p class="mb-2">{{ __('dashboard.resturantCount') }}</p>
                            ...
                            <div class="flex-wrap card-header d-flex justify-content-between">
                                ...
                                <div class="dropdown">
                                    <a class="btn btn-primary" data-bs-toggle="modal" data-placement="top"
                                        title="reportResturants" href="#reportResturants">{{ __('dashboard.reports') }}</a>
                                </div>
                                <div class="dropdown">
                                        ...
                                        <tbody>
                                            @foreach ($resturants as $key => $restaurant)
                                                <tr class="item" aria-valuenow="{{ $key }}">
                                                    ...
                                                    <td class="name">
                                                        <a
                                                            href="{{ route('resturantProducts', $restaurant->shopId) }}">{{ $restaurant->name }}</a>
                                                    </td>
                                                    <td class="from">{{ $restaurant->from }}</td>
                                                    <td class="to">{{ $restaurant->to }}</td>
                                                    <td class="count">{{ $restaurant->count }}</td>
                                                    <td>
