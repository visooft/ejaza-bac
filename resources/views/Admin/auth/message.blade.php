                    ...
                    <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                        <div class="card-body">
                            <a href="#" class="navbar-brand d-flex align-items-center mb-3">
                                <!--Logo start-->
                                <img src="{{ asset('Admin/assets/images/logo.png') }}" height="30px" class="svg"
                                    alt="">
                                <!--logo End-->
                                <h4 class="logo-title ms-3">{{ __('dashboard.title') }}</h4>
                            </a>
                            <img src="{{ asset('Admin/assets/images/auth/mail.png') }}" class="img-fluid"
                                width="80" alt="">
                            <h2 class="mt-3 mb-0">نجاح !</h2>
                            <p class="cnf-mail mb-1">تم إرسال بريد إلكتروني إلى <b>{{ $email }}</b>. يرجى التحقق
                                من وجود ملف
                                بريد إلكتروني من الشركة وانقر
                                على الرابط المضمن لإعادة تعيين كلمة المرور الخاصة بك.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-md-block d-none p-0 mt-n1 vh-100 overflow-hidden">
                    <img src="{{ asset('Admin/images/login.png') }}" class="img-fluid" alt="images" height="50%"
                        width="50%" style="margin-top: 200px; margin-right:100px">
                </div>
            </div>
        </section>
    </div>
