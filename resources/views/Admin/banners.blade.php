    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
                                        ...
                                        @foreach ($banners as $key => $banner)
                                            <tr>
                                                ...
                                                <td class="text-center"><img
                                                        ...
                                                        src="{{ $banner->image }}" alt="Category"></td>
                                                <td>
                                                    @foreach ($banner->cats as $cat)
                                                    {{ $cat->name }},
                                                    @endforeach
                                                </td>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal"
                                                            ...
                                                            onclick="myFunction(this, '{{ $banner->id }}', 'delete')"
                                                            href="#deleteModal">
                                                            <span class="btn-inner">
                                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        @if ($banner->status == 1)
                                                            <a class="btn btn-sm btn-icon"
                                                                ...
                                                                onclick="myFunction(this, '{{ $banner->id }}', 'hide')"
                                                                href="#hideBanner">
                                                                <span class="btn-inner">
                                                        ...
                                                        @else
                                                            <a class="btn btn-sm btn-icon"
                                                                ...
                                                                onclick="myFunction(this, '{{ $banner->id }}', 'show')"
                                                                href="#showBanner">
                                                                <span class="btn-inner">
                                            ...
                                            <div class="modal fade" id="editModal{{ $banner->id }}" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editModal">{{ __('dashboard.updateBanner') }}</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="card-body">

                                                                <form id="update-form" class="was-validated" action="{{ route('banners.update') }}"
                                                                    method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <input name="bannerId" type="hidden" value="{{ $banner->id }}" class="form-control">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <br>
                                                                        @php
                                                                            $shopsubs = \App\Models\Category::where('status', 1)->where('name_en', '!=', 'Resturant')->get();
                                                                        @endphp
                                                                        @foreach ($shopsubs as $category)
                                                                            <label class="checkbox-inline">
                                                                                <input id="checkBox" type="checkbox" class="chk-box"
                                                                                    name="subCategories[]" value="{{ $category->id }}"
                                                                                    @foreach ($banner->cats as $sub)
        ...
        <div class="modal fade" id="exampleModalDefault" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ __('dashboard.addBanner') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">

                            <form id="submit-form" class="was-validated" action="{{ route('banners.store') }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group mb-0">
                                    <label for="validationTextarea" class="form-label">{{ __('dashboard.image') }}
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($subCategories as $category)
                                        <label class="checkbox-inline">
                                            <input type="checkbox" class="chk-box" name="subCategories[]"
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModal">{{ __('dashboard.deleteBanner') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="{{ route('banners.delete') }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                            <input id="categoryIdDelete" name="bannerId" type="hidden" class="form-control">
                        </form>
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ __('dashboard.close') }}</button>
        ...
        <div class="modal fade" id="showBanner" tabindex="-1" aria-labelledby="showBanner" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="showBanner">{{ __('dashboard.showbanner') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="show-form" class="was-validated" action="{{ route('banners.show') }}"
                            method="POST">
                            @csrf
                            @method('put')
                            <input id="categoryIdShow" name="bannerId" type="hidden" class="form-control">
                        </form>
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ __('dashboard.close') }}</button>
        ...
        <div class="modal fade" id="hideBanner" tabindex="-1" aria-labelledby="hideBanner" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="hideBanner">{{ __('dashboard.hideBanner') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="hide-form" class="was-validated" action="{{ route('banners.hide') }}"
                            method="POST">
                            @csrf
                            @method('put')
                            <input id="categoryIdHide" name="bannerId" type="hidden" class="form-control">
                        </form>
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ __('dashboard.close') }}</button>
