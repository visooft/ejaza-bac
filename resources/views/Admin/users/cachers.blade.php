...
@section('main')
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
                                            ...
                                            @foreach ($data as $key => $cacher)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @else
                                                            <img class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                                                                src="https://ui-avatars.com/api/?name={{ $cacher->name }}"
                                                                alt="{{ $cacher->name }}">
                                                        @endif
                                                    </td>
                                                    <td><a
                                                            href="{{ route('getProfile', $cacher->id) }}">{{ $cacher->name }}</a>
                                                    </td>
                                                    <td>{{ $cacher->email }}</td>
                                                    <td>{{ $cacher->phone }}</td>
                                                    ...
                                                    <td>
                                                        <div class="flex align-items-center list-user-action">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="modal"
                                                                ...
                                                                onclick="myFunction(this, '{{ $cacher->id }}' ,'{{ $cacher->name }}', '{{ $cacher->phone }}' , '{{ $cacher->email }}' ,'update')"
                                                                href="#editModal">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal"
                                                                ...
                                                                onclick="myFunction(this, '{{ $cacher->id }}' ,'{{ $cacher->name }}', '{{ $cacher->phone }}' , '{{ $cacher->email }}' ,'delete')"
                                                                href="#deleteModal">
                                                                <span class="btn-inner">
                                                                    <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <tbody>
                                            @foreach ($cachers as $key => $cacher)
                                                <tr>
                                                    ...
                                                    <td>{{ $cacher->phone }}</td>
                                                    <td><a
                                                            href="{{ route('getStoreCacher', $cacher->shopId) }}">{{ $cacher->shopName }}</a>
                                                    </td>
                                                    <td>{{ $cacher->created_at }}</td>
                                                    <td>
                                                        @if ($cacher->status != 3)
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <form id="submit-form" class="was-validated" action="{{ route('cacher.store') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        title="{{ __('dashboard.validationTitlePhone') }}" type="tel" required value="{{ old('phone') }}">
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <form id="update-form" class="was-validated" action="{{ route('cacher.update') }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="{{ route('cacher.delete') }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <script>
            ...
            function myFunction(e, id, name, phone, email, type = "") {
