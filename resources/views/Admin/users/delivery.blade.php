                                        ...
                                        @foreach ($deliveries as $key => $delivery)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @else
                                                        <img class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                                                            src="https://ui-avatars.com/api/?name={{ $delivery->name }}"
                                                            alt="{{ $delivery->name }}">
                                                    @endif
                                                </td>
                                                <td><a
                                                        href="{{ route('getDeliveryProfile', $delivery->id) }}">{{ $delivery->name }}</a>
                                                </td>
                                                    ...
                                                    <div class="flex align-items-center list-user-action">
                                                        @can('superAdmin')
                                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="modal"
                                                                ...
                                                                onclick="myFunction(this, '{{ $delivery->id }}' ,'{{ $delivery->name }}', '{{ $delivery->phone }}' , '{{ $delivery->email }}', '{{ $delivery->cityId }}', '{{ $delivery->nationality }}', '{{ $delivery->bankName }}', '{{ $delivery->IPAN }}', '{{ $delivery->vechiel_type }}', '{{ $delivery->vechiel_plate_number }}', 'update')"
                                                                href="#editModal">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal"
                                                                ...
                                                                onclick="myFunction(this, '{{ $delivery->id }}' ,'{{ $delivery->name }}', '{{ $delivery->phone }}' , '{{ $delivery->email }}', '{{ $delivery->cityId }}', '{{ $delivery->nationality }}', '{{ $delivery->bankName }}', '{{ $delivery->IPAN }}', '{{ $delivery->vechiel_type }}', '{{ $delivery->vechiel_plate_number }}', 'delete')"
                                                                href="#deleteModal">
                                                                <span class="btn-inner">
                                                                    <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <form id="submit-form" class="was-validated" action="{{ route('delivery.store') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        maxlength="200" required value="{{ old('name') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        type="tel" required value="{{ old('phone') }}">
                                </div>
                                <div class="form-group">
                                    <label for="validationTextarea" class="form-label">
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        maxlength="200" required value="{{ old('nationality') }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="cityId" id="e9" class="form-select js-example-basic-single"
                                        required aria-label="select example" value="{{ old('cityId') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        maxlength="200" required value="{{ old('bankName') }}">
                                </div>
                                <div class="form-group">
                                    <label for="validationTextarea" class="form-label">
                                        {{ __('dashboard.IPAN') }}
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        maxlength="200" required value="{{ old('IPAN') }}">
                                </div>
                                <div class="form-group">
                                    <label for="validationTextarea" class="form-label">
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        maxlength="200" required value="{{ old('vechiel_type') }}">
                                </div>
                                <div class="form-group">
                                    <label for="validationTextarea" class="form-label">
                                    ...
                                    <input class="form-control is-invalid" id="validationTextarea"
                                        ...
                                        type="text" maxlength="200" required value="{{ old('vechiel_plate_number') }}">
                                </div>
                                <div class="form-group mb-0">
                                    ...
                                    <input required name="ID_image" type="file" class="form-control"
                                        aria-label="file example" value="{{ old('ID_image') }}">
                                    <div class="invalid-feedback">{{ __('dashboard.validationImage') }}</div>
                                </div>
                                <div class="form-group mb-0">
                                    <label for="validationTextarea"
                                    ...
                                    <input required name="vechiel_registeration" type="file" class="form-control"
                                        aria-label="file example" value="{{ old('vechiel_registeration') }}">
                                    <div class="invalid-feedback">{{ __('dashboard.validationImage') }}</div>
                                </div>
                                <div class="form-group mb-0">
