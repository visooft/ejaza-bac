(function(jQuery) {
    ...
    if (document.querySelectorAll('#d-main1').length) {
        const chart = new ApexCharts(document.querySelector("#d-main1"), options);
        chart.render();
        document.addEventListener('ColorChange', (e) => {
            console.log(e)
            const newOpt = {
    ...
    if (document.querySelectorAll('#d-main3').length) {
        const chart = new ApexCharts(document.querySelector("#d-main3"), options);
        chart.render();
        document.addEventListener('ColorChange', (e) => {
            console.log(e)
            const newOpt = {
