    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
                                                        ...
                                                        <div class="flex align-items-center list-user-action">
                                                            ...
                                                            @if ($slider->status == 1)
                                                                <a class="btn btn-sm btn-icon"
                                                                    ...
                                                                    onclick="myFunction(this, '{{ $slider->id }}', '{{ $slider->title_ar }}', '{{ $slider->title_en }}', '{{ $slider->title_tr }}','{{ $slider->desc_ar }}', '{{ $slider->desc_en }}', '{{ $slider->desc_tr }}', 'hide')"
                                                                    href="#hideSlider">
                                                                    <span class="btn-inner">
                                                            ...
                                                            @else
                                                                <a class="btn btn-sm btn-icon"
                                                                    ...
                                                                    onclick="myFunction(this, '{{ $slider->id }}', '{{ $slider->title_ar }}', '{{ $slider->title_en }}', '{{ $slider->title_tr }}','{{ $slider->desc_ar }}', '{{ $slider->desc_en }}', '{{ $slider->desc_tr }}', 'show')"
                                                                    href="#showSlider">
                                                                    <span class="btn-inner">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ __('dashboard.addSlider') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">

                            <form id="submit-form" class="was-validated" action="{{ route('sliders.store') }}"
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModal">{{ __('dashboard.updateSlider') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">

                            <form id="update-form" class="was-validated" action="{{ route('sliders.update') }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    <label for="validationTextarea"
                                        class="form-label">{{ __('dashboard.desc_ar') }}</label>
                                    <input class="form-control is-invalid" placeholder="{{ __('dashboard.desc_ar') }}"
                                        type="text" name="desc_ar" id="desc_ar" required>
                                </div>
                                <div class="form-group">
                                    <label for="validationTextarea"
                                        class="form-label">{{ __('dashboard.desc_en') }}</label>
                                    <input class="form-control is-invalid" placeholder="{{ __('dashboard.desc_en') }}"
                                        type="text" name="desc_en" id="desc_en" required>
                                </div>
                                <div class="form-group">
                                    <label for="validationTextarea" class="form-label">الوصف بالتركي</label>
                                    <input class="form-control is-invalid" placeholder="الوصف بالتركي" type="text"
                                        id="desc_tr" name="desc_tr" required>
                                </div>
                                <div class="form-group mb-0">
                                    <label for="validationTextarea" class="form-label">{{ __('dashboard.image') }}
                                        (jpeg,jpg,png,gif,webp)*</label>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModal">{{ __('dashboard.delteSlider') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="{{ route('sliders.delete') }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal fade" id="showSlider" tabindex="-1" aria-labelledby="showSlider" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="showSlider">{{ __('dashboard.showSlider') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="show-form" class="was-validated" action="{{ route('sliders.show') }}" method="POST">
                            @csrf
                            @method('put')
        ...
        <div class="modal fade" id="hideSlider" tabindex="-1" aria-labelledby="hideSlider" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="hideSlider">{{ __('dashboard.hideSlider') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="hide-form" class="was-validated" action="{{ route('sliders.hide') }}" method="POST">
                            @csrf
                            @method('put')
