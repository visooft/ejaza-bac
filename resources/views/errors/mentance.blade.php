...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="wrapper">
        <div class="gradient">
            <div class="container">
                <img src="{{ asset('Admin/assets/images/error/01.png') }}" class="img-fluid mb-4 w-50" alt="">

                @if (app()->getLocale() == 'ar')
                    <h2 class="mb-0 mt-4 text-white">{{ $MentanecMode->value_ar }}</h2>
                    <p class="mt-2 text-white">{{ $MentanecMode_value->value_ar }}</p>
                @else
                    <h2 class="mb-0 mt-4 text-white">{{ $MentanecMode->value_en }}</h2>
                    <p class="mt-2 text-white">{{ $MentanecMode_value->value_en }}</p>
                @endif
