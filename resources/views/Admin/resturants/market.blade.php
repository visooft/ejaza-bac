                                    ...
                                    <tbody>
                                        @foreach ($ads as $key => $ad)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('getDetialsmarket', $ad->id) }}">
                                                        {{ $ad->name_ar }}
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    @if ($status == 0)
                                                        <a href="{{ route('accepetResturantmarket', $ad->id) }}"
                                                            class="btn btn-success">{{ __('dashboard.Accepet') }}</a>
                                                        <a href="{{ route('rejecetResturantmarket', $ad->id) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="{{ route('market.delete') }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal fade" id="showcategory" tabindex="-1" aria-labelledby="showcategory" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="show-form" class="was-validated" action="{{ route('market.show') }}" method="POST">
                            @csrf
                            @method('put')
        ...
        <div class="modal fade" id="hidecategory" tabindex="-1" aria-labelledby="hidecategory" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="hide-form" class="was-validated" action="{{ route('market.hide') }}" method="POST">
                            @csrf
                            @method('put')
