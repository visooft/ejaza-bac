...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="wrapper">
        <div class="gradient">
            <div class="container">
                <img src="{{ asset('Admin/assets/images/error/404.png') }}" class="img-fluid mb-4 w-50" alt="">
                <h2 class="mb-0 mt-4 text-white">{{ __('dashboard.oops') }}</h2>
                <p class="mt-2 text-white">{{ __('dashboard.notFound') }}</p>
                <a class="btn bg-white text-primary d-inline-flex align-items-center"
                    href="{{ route('admin') }}">{{ __('dashboard.BackHome') }}</a>
            </div>
            <div class="box">
