                                    ...
                                    <tbody>
                                        @foreach ($ads as $key => $ad)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('getDetialstravel', $ad->id) }}">
                                                        {{ $ad->trave_type->name_ar }}
                                                    </a>
                                                </td>
                                                <td style="white-space: pre-wrap;">{{ $ad->desc_ar }}</td>
                                                <td>{{ $ad->category->name_ar }}</td>
                                                <td>{{ $ad->travel_country->name_ar }}</td>
                                                <td>{{ $ad->price }}</td>
                                                <td>{{ $ad->iban }}</td>
                                                <td>{{ $ad->user->name }}</td>
                                                <td>
                                                    @if ($status == 0)
                                                        <a href="{{ route('accepetResturanttravel', $ad->id) }}"
                                                            class="btn btn-success">{{ __('dashboard.Accepet') }}</a>
                                                        <a href="{{ route('rejecetResturanttravel', $ad->id) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="{{ route('travel.delete') }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal fade" id="showcategory" tabindex="-1" aria-labelledby="showcategory" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="show-form" class="was-validated" action="{{ route('travel.show') }}" method="POST">
                            @csrf
                            @method('put')
        ...
        <div class="modal fade" id="hidecategory" tabindex="-1" aria-labelledby="hidecategory" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="hide-form" class="was-validated" action="{{ route('travel.hide') }}" method="POST">
                            @csrf
                            @method('put')
