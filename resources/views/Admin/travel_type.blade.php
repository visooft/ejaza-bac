                                            ...
                                            <tr>
                                                ...
                                                @if($status == 1)
                                                    <td class="text-center"><img
                                                        ...
                                                        src="{{ asset('Admin/images/country/'.$category->image) }}" alt="Category"></td>
                                                @endif
                                                    ...
                                                    <td>
                                                        <div class="flex align-items-center list-user-action">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="modal"
                                                                ...
                                                                onclick="myFunction(this, '{{ $category->id }}', '{{ $category->name_ar }}' , '{{ $category->name_en }}', '{{ $category->name_tr }}' ,'update')"
                                                                href="#editModal">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal"
                                                                ...
                                                                onclick="myFunction(this, '{{ $category->id }}', '{{ $category->name_ar }}' , '{{ $category->name_en }}', '{{ $category->name_tr }}' ,'delete')"
                                                                href="#deleteModal">
                                                                <span class="btn-inner">
                                                                    <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            @if ($category->status == 1)
                                                                <a class="btn btn-sm btn-icon"
                                                                    ...
                                                                    onclick="myFunction(this, '{{ $category->id }}', '{{ $category->name_ar }}' , '{{ $category->name_en }}', '{{ $category->name_tr }}' ,'hide')"
                                                                    href="#hidecategory">
                                                                    <span class="btn-inner">
                                                            ...
                                                            @else
                                                                <a class="btn btn-sm btn-icon"
                                                                    ...
                                                                    onclick="myFunction(this, '{{ $category->id }}', '{{ $category->name_ar }}' , '{{ $category->name_en }}', '{{ $category->name_tr }}' ,'show')"
                                                                    href="#showcategory">
                                                                    <span class="btn-inner">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        @if($status == 0)
                            <h5 class="modal-title" id="exampleModalLabel">اضافة نوع الرحلة</h5>
                        @endif
                        @if($status == 1)
                            <h5 class="modal-title" id="exampleModalLabel">اضافة دولة</h5>
                        @endif
                        @if($status == 2)
                            <h5 class="modal-title" id="exampleModalLabel">اضافة نوع التسوق</h5>
                        @endif
                        @if($status == 3)
                            <h5 class="modal-title" id="exampleModalLabel">اضافة  تصنيف الرحلة</h5>
                        @endif
                        @if($status == 4)
                            <h5 class="modal-title" id="exampleModalLabel">اضافة مرفق</h5>
                        @endif
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <form id="submit-form" class="was-validated" action="@if($status == 0) {{ route('travel_type.store') }} @elseif($status == 1) {{ route('travel_country.store') }} @elseif($status == 2) {{ route('market_type.store') }} @elseif($status == 3) {{ route('event_type.store') }} @elseif($status == 4) {{ route('accompanying.store') }} @endif"
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        @if($status == 0)
                            <h5 class="modal-title" id="editModal">تعديل نوع الرحلة</h5>
                        @endif
                        @if($status == 1)
                            <h5 class="modal-title" id="editModal">تعديل الدولة</h5>
                        @endif
                        @if($status == 2)
                            <h5 class="modal-title" id="editModal">تعديل نوع التسوق</h5>
                        @endif
                        @if($status == 3)
                            <h5 class="modal-title" id="editModal">تعديل تصنيف الرحلة </h5>
                        @endif
                        @if($status == 4)
                            <h5 class="modal-title" id="editModal">تعديل مرفق  </h5>
                        @endif
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <form id="update-form" class="was-validated" action="@if($status == 0) {{ route('travel_type.update') }} @elseif($status == 1) {{ route('travel_country.update') }} @elseif($status == 2) {{ route('market_type.update') }} @elseif($status == 3) {{ route('event_type.update') }} @elseif($status == 4) {{ route('accompanying.update') }} @endif"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        @if($status == 0)
                        <h5 class="modal-title" id="deleteModal">حذف نوع الرحلة</h5>
                        @endif
                        @if($status == 1)
                        <h5 class="modal-title" id="deleteModal">حذف الدولة</h5>
                        @endif
                        @if($status == 2)
                        <h5 class="modal-title" id="deleteModal">حذف نوع التسوق</h5>
                        @endif
                        @if($status == 3)
                        <h5 class="modal-title" id="deleteModal">حذف تصنيف الرحلة </h5>
                        @endif
                        @if($status == 4)
                        <h5 class="modal-title" id="deleteModal">حذف مرفق </h5>
                        @endif
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="@if($status == 0) {{ route('travel_type.delete') }} @elseif($status == 1) {{ route('travel_country.delete') }} @elseif($status == 2) {{ route('market_type.delete') }} @elseif($status == 3) {{ route('event_type.delete') }} @elseif($status == 4) {{ route('accompanying.delete') }} @endif"
                            method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal fade" id="showcategory" tabindex="-1" aria-labelledby="showcategory" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        @if($status == 0)
                            <h5 class="modal-title" id="showcategory">اظهار نوع الرحلة</h5>
                        @endif
                        @if($status == 1)
                            <h5 class="modal-title" id="showcategory">اظهار الدولة</h5>
                        @endif
                        @if($status == 2)
                            <h5 class="modal-title" id="hidecategory">اظهار نوع التسوق</h5>
                        @endif
                        @if($status == 3)
                            <h5 class="modal-title" id="hidecategory">اظهار تصنيف الرحلة</h5>
                        @endif
                        @if($status == 4)
                            <h5 class="modal-title" id="hidecategory">اظهار مرفق </h5>
                        @endif
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="show-form" class="was-validated" action="@if($status == 0) {{ route('travel_type.show') }} @elseif($status == 1) {{ route('travel_country.show') }} @elseif($status == 2) {{ route('market_type.show') }} @elseif($status == 3) {{ route('event_type.show') }} @elseif($status == 4) {{ route('accompanying.show') }} @endif"
                            method="POST">
                            @csrf
                            @method('put')
        ...
        <div class="modal fade" id="hidecategory" tabindex="-1" aria-labelledby="hidecategory" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        @if($status == 0)
                            <h5 class="modal-title" id="hidecategory">اخفاء نوع الرحلة</h5>
                        @endif
                        @if($status == 1)
                            <h5 class="modal-title" id="hidecategory">اخفاء الدولة</h5>
                        @endif
                        @if($status == 2)
                            <h5 class="modal-title" id="hidecategory">اخفاء نوع التسوق</h5>
                        @endif
                        @if($status == 3)
                            <h5 class="modal-title" id="hidecategory">اخفاء تصنيف الرحلة</h5>
                        @endif
                        @if($status == 4)
                            <h5 class="modal-title" id="hidecategory">اخفاء مرفق</h5>
                        @endif
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="hide-form" class="was-validated" action="@if($status == 0) {{ route('travel_type.hide') }} @elseif($status == 1) {{ route('travel_country.hide') }} @elseif($status == 2) {{ route('market_type.hide') }} @elseif($status == 3) {{ route('event_type.hide') }} @elseif($status == 4) {{ route('accompanying.hide') }} @endif"
                            method="POST">
                            @csrf
                            @method('put')
