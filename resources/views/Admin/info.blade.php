    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ __('dashboard.addInfo') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">

                            <form id="submit-form" class="was-validated" action="{{ route('info.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="key" class="form-select" required aria-label="select example">
                                        ...
                                        <option value="phone">{{ __('dashboard.phone') }}</option>
                                        <option value="address">{{ __('dashboard.address') }}</option>
                                        <option value="whatsapp">{{ __('dashboard.whatsapp') }}</option>
                                    </select>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModal">{{ __('dashboard.updateInfo') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">

                            <form id="update-form" class="was-validated" action="{{ route('info.update') }}"
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="{{ route('info.delete') }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
