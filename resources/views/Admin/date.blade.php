    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                           ...
                                                           onclick="myFunction(this, '{{ $date->id }}', '{{ $date->year }}' ,'update')"
                                                           href="#editModal">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal"
                                                           ...
                                                           onclick="myFunction(this, '{{ $date->id }}', '{{ $date->year }}' ,'delete')"
                                                           href="#deleteModal">
                                                                <span class="btn-inner">
                                                                    <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                         xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        @if ($date->status == 1)
                                                            <a class="btn btn-sm btn-icon"
                                                               ...
                                                               onclick="myFunction(this, '{{ $date->id }}', '{{ $date->year }}', 'hide')"
                                                               href="#hideSlider">
                                                                    <span class="btn-inner">
                                                        ...
                                                        @else
                                                            <a class="btn btn-sm btn-icon"
                                                               ...
                                                               onclick="myFunction(this, '{{ $date->id }}', '{{ $date->year }}', 'show')"
                                                               href="#showSlider">
                                                                    <span class="btn-inner">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">اضافه سنة</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">
                            <form id="submit-form" class="was-validated" action="{{ route('date.store') }}"
                                  method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="validationTextarea"
                                           class="form-label">{{ __('dashboard.This_Year') }}</label>
                                    <input class="form-control is-invalid" id="validationTextarea"
                                           placeholder="1997" type="text" name="year" required>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModal">تحديث سنة</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">
                            <form id="update-form" class="was-validated" action="{{ route('date.update') }}"
                                  method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input id="yearId" name="yearId" type="hidden" class="form-control">
                                <div class="form-group">
                                    <label for="validationTextarea"
                                           class="form-label">{{ __('dashboard.This_Year') }}</label>
                                    <input class="form-control is-invalid" id="year"
                                           placeholder="1997" type="text" name="year" required>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModal">حذف السنة</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="delete-form" class="was-validated" action="{{ route('date.delete') }}"
                              method="POST">
                            @csrf
                            @method('DELETE')
                            <input id="yearIdDelete" name="yearId" type="hidden" class="form-control">
                        </form>
                        <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal">{{ __('dashboard.close') }}</button>
        ...
        <div class="modal fade" id="showSlider" tabindex="-1" aria-labelledby="showSlider" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="showSlider">اظهار السنة</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="show-form" class="was-validated" action="{{ route('date.show') }}" method="POST">
                            @csrf
                            @method('put')
                            <input id="sliderIdShow" name="yearId" type="hidden" class="form-control">
                        </form>
                        <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal">{{ __('dashboard.close') }}</button>
        ...
        <div class="modal fade" id="hideSlider" tabindex="-1" aria-labelledby="hideSlider" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="hideSlider">اخفاء السنة</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
                        <form id="hide-form" class="was-validated" action="{{ route('date.hide') }}" method="POST">
                            @csrf
                            @method('put')
                            <input id="sliderIdHide" name="yearId" type="hidden" class="form-control">
                        </form>
                        <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal">{{ __('dashboard.close') }}</button>
        ...
        <script>
            function myFunction(e, id, year, type = "") {
                if (type == "update") {
                    const e = document.getElementById('yearId');
                    if (e) {
                        e.value = id;
                        document.getElementById('year').value = year;
                    }
                } else if (type == "delete") {
                    const e = document.getElementById('yearIdDelete');
                    if (e) e.value = id;
                } else if (type == "show") {
